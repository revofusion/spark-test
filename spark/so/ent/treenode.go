...
type TreeNode struct {
	...
	// RawTx holds the value of the "raw_tx" field. Also sometimes referred to as NodeTx.
	RawTx []byte `json:"raw_tx,omitempty"`
	// DirectTx holds the value of the 'direct_tx' field. Also sometimes referred to as DirectNodeTx.
	...
	// Valid transaction ID of the stored node transaction. Generated by hooks from raw_tx.
	RawTxid []byte `json:"raw_txid,omitempty"`
	// Valid transaction ID of the stored direct node transaction. Generated by hooks from direct_tx.
	DirectTxid []byte `json:"direct_txid,omitempty"`
	// Valid transaction ID of the stored direct from CPFP node transaction. Generated by hooks from direct_from_cpfp_refund_tx.
	DirectFromCpfpRefundTxid []byte `json:"direct_from_cpfp_refund_txid,omitempty"`
	// A transaction to exit Spark unilaterally. Only leafs have this transaction. Also sometimes referred to as cpfpRefundTx.
	...
	// Valid transaction ID of the stored refund transaction. Generated by hooks from raw_refund_tx.
	RawRefundTxid []byte `json:"raw_refund_txid,omitempty"`
	// Valid transaction ID of the direct refund transaction. Generated by hooks from direct_refund_tx.
