...
func (TreeNode) Fields() []ent.Field {
	return []ent.Field{
		...
		// Node transactions
		field.Bytes("raw_tx").NotEmpty().Comment("RawTx holds the value of the \"raw_tx\" field. Also sometimes referred to as NodeTx."),
		field.Bytes("direct_tx").Optional().Comment("DirectTx holds the value of the 'direct_tx' field. Also sometimes referred to as DirectNodeTx."),
		...
		// Refund transactions
		field.Bytes("raw_refund_tx").Optional().Comment("A transaction to exit Spark unilaterally. Only leafs have this transaction. Also sometimes referred to as cpfpRefundTx."),
